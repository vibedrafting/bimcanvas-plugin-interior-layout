...
### 可选/附属家具
- [可选家具·如梳妆台/斗柜/展示柜]：**主动尝试布置**——优先采用「多方案战略层概述」给的可选建议；无建议则按房间策略可选清单（bedroom.md「可选家具」节）自推候选位。**可选为主家具让路**：不与主家具争墙、不侵占已声明留白/主通道/门禁（ez_*）。真放不下才写"省略"，且**必须给坐标级理由**（哪面墙剩多少、被谁占、为何不够）——**禁"留空保通道"之类 hand-wave**。
- [附属家具·如床头柜/窗帘]：跟随主家具（保留/补充）+ 锚点位置或原因
