...
2. 逐个可选家具做**闭合预检**：能否在**不侵占主家具 / 已声明留白 / 主通道 / 门禁（ez_*）**前提下塞入（在采光好与组合便利间权衡、别挡通道）。
...
5. **边界**：补可选**不动主家具墙归属 / 不改方向 / 不侵占几何成立的留白（通道 / 操作净空 / 门禁）**——这与「不可静默执行」里的"新增主家具"无关，补可选是本分身正当职责。
6. **叙事性留白不是终点**：若可选家具仅被**叙事性留白**（"开阔感""释放某墙"之类非几何必需的声明）挡住、几何上其实放得下，本轮不强行落位，但**必须在 `optimizationRecord` 记 `[自动改图建议]`**（写明哪面墙几何可行、被哪条叙事声明挡住），**禁止静默放弃**——是否突破叙事性留白由用户/上游定夺，你的职责是把这个可行选项暴露出来。
